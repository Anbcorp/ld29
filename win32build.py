...
class BuildExe:
    def __init__(self):
        ...
        #Auhor of program
        self.author_name = "Benoit 'Anb' Depail"
        self.author_email = "benoit@anbcorp.net"
        self.copyright = "Copyreich (c), go die"

        #Description
        self.project_description = "LD29 entry"
    ...
    def run(self):
        ...
        extra_datas = [ ('res', glob.glob('res/*.*')) , ('.', ['resources.yaml']) ]
